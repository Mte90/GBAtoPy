...
impl ThumbDecoder {
    ...
    pub fn decode(&self, halfword: u16, address: u32) -> (String, Vec<crate::Operand>, bool) {
        match halfword >> 8 {
            ...
            0x28..=0x2B => self.format_3_add(halfword),
            0x2C..=0x2F => self.format_3_sub(halfword),
            0x30..=0x37 => self.format_3_mov(halfword),
            0x38..=0x3F => self.format_3_cmp(halfword),
            ...
            0x78..=0x7F => self.format_10_halfword(halfword),
            0x80..=0x87 => self.format_9_imm_offset_word(halfword),
            ...
            0xB0..=0xB7 => self.format_13_add_offset_sp(halfword),
            0xB8..=0xBF => self.format_14_push_pop(halfword),
